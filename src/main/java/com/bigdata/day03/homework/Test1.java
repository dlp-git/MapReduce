...
import com.bigdata.day03.definedGroupingDemo.DefinedSubjectGrouping;
import com.bigdata.day03.definedGroupingDemo.stuGroupBean;
...
public class Test1 {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setJarByClass(Work1.class);

        job.setMapperClass(Work1.avgScoreMap.class);
        job.setMapOutputKeyClass(stuInfoBean.class);
        job.setMapOutputValueClass(NullWritable.class);

        job.setPartitionerClass(Work1.subjectPartiton.class);
//        指定自定义分组的类
//        job.setGroupingComparatorClass(Work1.subjectGroup.class);
...
//        job.setOutputValueClass(NullWritable.class);
        ...
        Path inPath=new Path("./datas/stuInfo*");
//        Path outPath=new Path("./subDefPar001");
        Path outPath=new Path("./stuGroupPartition001");
